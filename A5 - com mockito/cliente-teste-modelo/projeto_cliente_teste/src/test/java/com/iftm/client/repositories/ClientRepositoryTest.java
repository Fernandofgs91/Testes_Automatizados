...
public class ClientRepositoryTest {
    ...
    // Teste: busca por CPF inexistente
    @Test
    @DisplayName("Testa busca por CPF inexistente retorna lista vazia.")
    void testFindClientsByCpfInexistente() {
    ...
    // Teste: busca por faixa de renda sem clientes
    @Test
    @DisplayName("Testa busca por faixa de renda sem clientes retorna lista vazia.")
    void testFindClientsByIncomeBetweenSemClientes() {
        Double minIncome = 99999.0;
    ...
    // Teste: busca por faixa de filhos sem clientes
    @Test
    @DisplayName("Testa busca por faixa de filhos sem clientes retorna lista vazia.")
    void testFindByChildrenBetweenSemClientes() {
        Integer minChildren = 10;
        Integer maxChildren = 20;
        List<Client> result = repository.findByChildrenBetween(minChildren, maxChildren);
        assertNotNull(result);
        assertEquals(0, result.size());
    }

    // Teste: busca por múltiplo de renda sem clientes
    @Test
    @DisplayName("Testa busca por múltiplo de renda sem clientes retorna lista vazia.")
    void testFindByIncomeMultipleOfSemClientes() {
        Double value = 123.0;
        List<Client> result = repository.findByIncomeMultipleOf(value);
        assertNotNull(result);
        assertEquals(0, result.size());
    ...
    // Teste: busca por sufixo inexistente
    @Test
    @DisplayName("Testa busca por nome terminado com sufixo inexistente retorna lista vazia.")
    void testFindByNameEndingWithIgnoreCaseSufixoInexistente() {
        String suffix = "xyz";
        List<Client> result = repository.findByNameEndingWithIgnoreCase(suffix);
        assertNotNull(result);
        assertEquals(0, result.size());
